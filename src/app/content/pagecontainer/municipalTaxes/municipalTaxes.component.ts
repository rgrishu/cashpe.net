...
@Component({
  selector: 'aditya-municipalTaxes',
  templateUrl: './municipalTaxes.component.html',
  styleUrls: ['./municipalTaxes.component.css']
})
export class MunicipalTaxesComponent implements OnInit {
  RechargeForm:FormGroup;
  mobile:any;
  amount:number;
  MobileplaceHolder='Select MunicipalTaxes Operator'
  AccountRemark=''
  odata:any;
  public operator:0;
  ...
  public Operatorchanged(e: any): void {
    ...
    if(this.operator==0)
    {
      this.MobileplaceHolder='Select MunicipalTaxes Operator';
      return;
    }
  ...
  GetB2CBanner()
  {
    var req={opType:OpTypes.MunicipalTaxes};
