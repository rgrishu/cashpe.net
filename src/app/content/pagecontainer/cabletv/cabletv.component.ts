import { AfterContentInit, Component, OnInit, Pipe, ViewChild } from '@angular/core';
...
@Component({
  selector: 'aditya-cabletv',
  templateUrl: './cabletv.component.html',
  styleUrls: ['./cabletv.component.css']
})
@Pipe({
  name: 'safe'
})
export class CabletvComponent implements OnInit {
  ...
  mobile:any;
  amount:number;
  MobileplaceHolder='Select Cable TV Operator'
  AccountRemark=''
  odata:any;
  ...
  // slides = [
  //   {img: "../../../../assets/img/cus-img/Broadband.jpg"}
  ...
  public Operatorchanged(e: any): void {
    ...
    if(this.operator==0)
    {
      this.MobileplaceHolder='Select CableTV Operator';
      return;
    }
  ...
  GetB2CBanner()
  {
    var req={opType:OpTypes.Broadband};
