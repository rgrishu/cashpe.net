...
@Component({
  selector: 'aditya-educationFess',
  templateUrl: './educationFess.component.html',
  styleUrls: ['./educationFess.component.css']
})
export class EducationFessComponent implements OnInit {
  RechargeForm:FormGroup;
  mobile:any;
  amount:number;
  MobileplaceHolder='Select EducationFess Operator'
  AccountRemark=''
  odata:any;
  public operator:0;
  ...
  public Operatorchanged(e: any): void {
    ...
    if(this.operator==0)
    {
      this.MobileplaceHolder='Select EducationFess Operator';
      return;
    }
  ...
  GetB2CBanner()
  {
    var req={opType:OpTypes.EducationFees};
