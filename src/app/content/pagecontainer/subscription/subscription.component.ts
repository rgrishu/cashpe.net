...
export class SubscriptionComponent implements OnInit {
  ...
  mobile:any;
  amount:number;
  MobileplaceHolder='Select Subscripation Operator'
  AccountRemark=''
  odata:any;
  public operator:0;
  ...
  public Operatorchanged(e: any): void {
    ...
    if(this.operator==0)
    {
      this.MobileplaceHolder='Select Subscripation Operator';
      return;
    }
  ...
  GetB2CBanner()
  {
    var req={opType:OpTypes.Subscription};
