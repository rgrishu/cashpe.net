...
@Component({
  selector: 'aditya-barAssociationFee',
  templateUrl: './barAssociationFee.component.html',
  styleUrls: ['./barAssociationFee.component.css']
})
export class BarAssociationFeeComponent implements OnInit {
  RechargeForm:FormGroup;
  mobile:any;
  amount:number;
  MobileplaceHolder='Select BarAssociationFee Operator'
  AccountRemark=''
  odata:any;
  public operator:0;
  ...
  public Operatorchanged(e: any): void {
    ...
    if(this.operator==0)
    {
      this.MobileplaceHolder='Select BarAssociationFee Operator';
      return;
    }
  ...
  GetB2CBanner()
  {
    var req={opType:OpTypes.BARAssociationFee};
